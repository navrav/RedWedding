		    ...
		    <a href="#nav"> <span class="glyphicon glyphicon-th-list"> </span></a>
				<span style="position: absolute; right: 40px; top: 10px;font-size:11px">Rank: 356 </span>
		  		<span style="position: absolute; right: 40px;  top: 26px; font-size:11px">AEBuxs: 30 </span>
