...
?>
		    ...
		    <a href="#nav"> <span class="glyphicon glyphicon-th-list"> </span></a>
				<span style="position: absolute; right: 40px; top: 24px;font-size:11px">Rank: <?php echo $rank; ?></span>
		  		<span style="position: absolute; right: 40px;  top: 40px; font-size:11px">AEBuxs: <?php echo $aebux; ?></span>
		  		<span style="position: absolute; right: 40px;  top: 55px; font-size:11px"> <a style="background-color: inherit;
