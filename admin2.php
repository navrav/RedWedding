...
<body>
  ...
  <section>
		...
		<form id="searchroomForm" method="POST" action="adminSearch.php">
		 <input type="text" name="searchRoom" class="searchbar" value="" placeholder="Search Rooms..." data-theme="white"></input>
